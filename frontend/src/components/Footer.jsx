...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-r from-blue-900 via-indigo-900 to-purple-900 py-12 text-gray-100">
      <div className="container px-6 mx-auto">
        <div className="flex flex-wrap justify-between">
          {/* Logo and Description */}
          <div className="w-full xl:w-1/4 mb-8">
            <a href="/" className="block mb-4">
              {/* You can replace this with your app's logo */}
              <svg className="w-24 h-24 text-blue-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                <path d="M..."></path>
              </svg>
            </a>
          ...
          <div className="w-full sm:w-1/4 mb-8">
            ...
            <ul className="space-y-2">
              <li><a href="/about" className="block hover:text-blue-400 transition-colors duration-200">About Us</a></li>
              <li><a href="/contact" className="block hover:text-blue-400 transition-colors duration-200">Contact</a></li>
              <li><a href="/careers" className="block hover:text-blue-400 transition-colors duration-200">Careers</a></li>
            </ul>
          </div>
          ...
          <div className="w-full sm:w-1/4 mb-8">
            ...
            <ul className="space-y-2">
              <li><a href="/faq" className="block hover:text-blue-400 transition-colors duration-200">FAQ</a></li>
              <li><a href="/terms" className="block hover:text-blue-400 transition-colors duration-200">Terms & Conditions</a></li>
              <li><a href="/privacy" className="block hover:text-blue-400 transition-colors duration-200">Privacy Policy</a></li>
            </ul>
          </div>
          ...
          <div className="w-full sm:w-1/4 mb-8">
            ...
            <div className="flex space-x-6">
              <a href="https://twitter.com" className="text-blue-400 hover:text-blue-300 transition-colors duration-200">
              ...
              <a href="https://linkedin.com" className="text-blue-400 hover:text-blue-300 transition-colors duration-200">
                <svg className="w-6 h-6" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
              ...
              <a href="https://github.com" className="text-blue-400 hover:text-blue-300 transition-colors duration-200">
                <svg className="w-6 h-6" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} PeerToPeer. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
